...
function GardenPage({ onNavigate }) {
    ...
    const fetchPlants = async () => {
        ...
        try {
            ...
            if (err.response && err.response.status === 401) {
                ...
                // onNavigate('login'); // Uncomment if you have a login navigation
            } else {
        ...
        <div style={{ backgroundColor: '#Fffff', minHeight: '100vh', fontFamily: 'Nunito, sans-serif' }} className="d-flex flex-column no-select">
            ...
            <main className="flex-grow-1">
                ...
                {loading ? (
                    ...
                    <>
                        {page === 'overview' && <GardenOverview plants={plants} onNavigate={setPage} onViewDetails={handleViewDetails} onDiagnoseClick={() => onNavigate('diagnosePage')} />}
