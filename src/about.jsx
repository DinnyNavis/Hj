    ...
    <div className="min-h-screen font-sans">
      ...
      <div className="container my-5 px-4">
        ...
        <section id="home" className="text-center my-5 py-5">
          ...
          <h1 className="display-5 fw-bold">Why We Built UrbanGrow</h1>
        ...
        <section id="features" className="row align-items-center my-5 py-4">
          ...
          <div className="col-md-6">
            ...
            <p className="text-secondary">
              That's where UrbanGrow AI comes in. We believe that everyone deserves the joy and benefits of gardening—no matter where they live.
            </p>
          </div>
        </section>
        ...
        <section className="row align-items-center my-5 py-4 flex-md-row-reverse">
          ...
          <div className="col-md-6">
            ...
            <p className="text-secondary">
              UrbanGrow makes gardening easy and smart. We leverage AI to guide you through your urban farming journey. From selecting plants suited for your sunlight to diagnosing diseases with a photo, we simplify it all.
            </p>
            <p className="text-secondary">
        ...
        <section id="my-garden-section" className="text-center my-5 py-4">
          ...
          <p className="text-secondary">
            Whether you're a seasoned gardener or just starting out, UrbanGrow AI is your perfect companion. Let’s grow together!
          </p>
        </section>
      </div>
    </div>
