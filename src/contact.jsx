                ...
                <div className="card shadow-sm p-4 rounded-lg compact-card follow-card">
                  <div className="card-body">
                    ...
                    <div className="d-flex social-icons justify-content-center">
                      <a href="https://instagram.com/growlify" target="_blank" rel="noopener noreferrer" className="me-3 hover-scale-icon text-instagram">
                      ...
                      <a href="https://youtube.com/growlify" target="_blank" rel="noopener noreferrer" className="me-3 hover-scale-icon text-youtube">
