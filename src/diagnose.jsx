...
function Diagnose() {
  ...
  const handleDiagnosisClick = async () => {
    ...
    try {
      ...
      // Assuming your Flask app returns { prediction: { name, cause, cure } }
  ...
  return (
    // Main container for the Diagnose page content, with styling for vertical positioning and font.
    <div style={{ minHeight: 'calc(100vh - 90px)', paddingTop: '90px', paddingBottom: '2rem', fontFamily: 'var(--font-inter)' }}>
      <div className="container d-flex flex-column align-items-center justify-content-center text-center">
        ...
        <div className="card shadow-sm p-4 mb-5" style={{ maxWidth: '700px', width: '100%', borderRadius: '0.75rem', backgroundColor: 'var(--secondary)' }}>
          <div className="card-body text-start">
            ...
            <ol className="list-group list-group-flush">
              ...
              <li className="list-group-item border-0 ps-0 py-1" style={{ backgroundColor: 'transparent' }}>
                2. Click 'Upload and Check Availability' and our AI will analyze the photo.
              </li>
              <li className="list-group-item border-0 ps-0 py-1" style={{ backgroundColor: 'transparent' }}>
                3. Receive a diagnosis and tailored care recommendations.
              </li>
            </ol>
          </div>
        </div>
        ...
        <div className="card shadow-sm p-4" style={{ maxWidth: '700px', width: '100%', borderRadius: '0.75rem', backgroundColor: 'var(--card)' }}>
          <div className="card-body text-start">
            <h5 className="card-title mb-4 fw-bold">Plant Diagnosis</h5>
            ...
            {/* Upload and Check Availability Button */}
            <div className="d-grid gap-2">
              <button
                type="button"
                className="btn btn-primary btn-lg rounded-pill" // Using Bootstrap's btn-primary class
                style={{
                  backgroundColor: '#6c757d', // A more neutral, modern grey (like Bootstrap's secondary)
                  borderColor: '#6c757d',
                  fontSize: '1.2rem',
                ...
                onMouseEnter={(e) => e.currentTarget.style.backgroundColor = '#5a6268'} // Darken on hover
                onMouseLeave={(e) => e.currentTarget.style.backgroundColor = '#6c757d'} // Restore on mouse leave
                onClick={handleDiagnosisClick}
                disabled={isLoading} // Disable button while loading
              >
                {isLoading ? ( // Show spinner and "Analyzing..." when loading
                  <>
                    <span className="spinner-border spinner-border-sm me-2" role="status" aria-hidden="true"></span>
                    Analyzing...
                  </>
                ) : 'Upload and Check Availability'} {/* Button text when not loading */}
              </button>
            </div>
            ...
            {diagnosisResult && (
              <div className="mt-5 pt-3 border-top border-2"> {/* Added top border for clear separation */}
                <h4 className="mb-4 fw-bolder text-success">Diagnosis Result: 🌱</h4> {/* Larger, bolder heading with plant emoji */}
                  ...
                  <div className="card-body text-start p-4"> {/* Increased padding inside the card */}
                    <div className="mb-3">
                      ...
                      <p className="card-text fw-bold text-dark" style={{ fontSize: '1.3rem', letterSpacing: '0.5px' }}>
                        ...
                        {diagnosisResult.name.replace(/___/g, ' - ').replace(/_/g, ' ')}
                      </p>
                    </div>
