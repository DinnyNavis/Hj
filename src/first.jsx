...
const HomePageContent = ({ onNavigate }) => {
    ...
    <>
        ...
        <div className="row justify-content-center">
          <div className="col-md-10 col-lg-8">
            ...
            <div className="d-grid gap-2 d-sm-flex justify-content-sm-center">
              <button type="button" className="btn btn-lg btn-custom-green" onClick={() => onNavigate('myGarden')}>Get Started</button>
              <button type="button" className="btn btn-lg btn-outline-custom"onClick={() => onNavigate('aboutUs')}>Learn How It Works</button>
            </div>
          </div>
        </div>
      </header>
      ...
      <section className="container text-center py-5 section-padding" id="features-section">
        ...
        <div className="mt-5 d-flex justify-content-center">
          <button type="button" className="btn btn-link text-success text-decoration-none fw-bold" onClick={() => onNavigate('featuresPage')}>See All Features &rarr;</button>
        </div>
      </section>
 ...
 <button
 type="button"
 className="btn btn-light btn-md rounded-pill px-4 py-2"
onClick={() => onNavigate('auth')} > Sign Up</button>
