...
const API_BASE_URL = 'http://localhost:5000/api'; // This base URL is no longer directly used for weather
...
const Profile = ({ onNavigate }) => {
  ...
  useEffect(() => {
    ...
    if (storedUser) {
      ...
      // fetchWeather(user.city); // Removed here
    }
  }, []);
  ...
  const fetchWeather = async (city) => {
    ...
    try {
      ...
      setWeatherError(error.response?.data?.message || 'Failed to fetch weather data. Please try again.');
      setWeatherData(null);
    } finally {
  ...
  const handleSaveProfile = async () => {
    ...
    try {
      ...
      // fetchWeather(location); // Removed here, as useEffect will handle it
    } catch (error) {
      ...
      <div className="container pt-2 pb-4 d-flex justify-content-center">
        ...
        <div className="card shadow-sm" style={styles.card}>
          <div className="card-body">
            ...
            <div className="mb-4">
              ...
              <div className="mb-3">
                ...
                <input
                  ...
                  id="fullName"
                  value={fullName} // Binds to state for editing
                  onChange={(e) => setFullName(e.target.value)} // Enables editing
              ...
              <div className="mb-3">
                ...
                <input
                  ...
                  className="form-control"
                  id="emailAddress"
                  value={emailAddress} // Use value for controlled component, even if readOnly
                  readOnly
                  style={styles.inputField}
                />
              ...
              <div className="mb-3">
                ...
                <input
                  ...
                  className="form-control"
                  id="location"
                  value={location} // Binds to state for editing
                  onChange={(e) => setLocation(e.target.value)} // Enables editing
                  style={styles.inputField}
                />
                <div className="form-text mt-1">
                  Your city or general location for tailored advice.
                </div>
              </div>
            </div>
            ...
            <div className="mb-4">
              <h5 className="mb-2" style={styles.sectionHeader}>Current Weather in {location || 'Your City'}</h5>
              <p className="text-muted mb-3">Get real-time weather updates for your registered location.</p>
              {weatherLoading ? (
                ...
                <div className="text-center text-muted">No weather data available. Please ensure your location is set.</div>
              )}
            </div>
            ...
            <div className="d-grid gap-2">
              <button type="button" className="btn btn-primary" onClick={handleSaveProfile} style={styles.saveButton}>
