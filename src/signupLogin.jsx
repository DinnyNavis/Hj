...
function SignupLogin({ onNavigate }) {
    ...
    const sendSignupOTP = async () => {
        ...
        try {
            ...
            setMessage(err.response?.data?.message || 'Failed to send OTP. Please try again later.');
        }
    };
        ...
        <>
            {showSignupOTPPage ? renderSignupOTPForm() : (
                <div className="form-content">
                    ...
                    <p className="form-subtitle">Join UrbanGrow AI to start your smart garden.</p>
    ...
    return (
        <div className="signup-login-container">
            ...
            <div className="card-wrapper">
                ...
                {/* Message Display */}
                {message && (
                    <div className={`message-alert ${message.toLowerCase().includes('failed') ||
                        message.toLowerCase().includes('invalid') || message.toLowerCase().includes('error') ? 'error' : 'success'}`}>
                        {message}
                    </div>
                )}
